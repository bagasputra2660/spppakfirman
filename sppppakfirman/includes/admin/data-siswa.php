    ...
    <tr>
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="?p=ubah-siswa&id=<?= $dt_siswa['id_siswa']; ?>">Ubah</a> 
                | <a href="?p=hapus-siswa&id=<?= $dt_siswa['id_siswa']; ?>" onclick="return confirm('Yakin data ini akan dihapus?')">Hapus</a></td>
            </tr>
